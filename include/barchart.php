...
<?php
    $uid = $_SESSION['user'];
    $strQuery = "SELECT transaction_date,finance_type_id,SUM(amount) FROM finances WHERE user_id = $uid GROUP BY transaction_date,category_id ORDER BY transaction_date ASC;";
