...
<div class="card-body" id="piechart_1" style="width:100%; height: 100%;"></div>
...
<table class="table table-striped">
	...
	<tbody>
		<?php
			$sno = 1;
			$uid = $_SESSION['user'];
			$result = mysqli_query($conn, "SELECT * FROM $table WHERE finance_type_id=1 AND user_id = $uid ORDER BY transaction_date DESC, amount DESC");
						    	...
						    	<div class="modal-content">
									<div class="modal-body">
											<form class="form" method="post"  action="database/edit_data.php">
												...
												<input type="text" value="1" name="finance_type_id" hidden>
												<div class="row">
												...
												<div class="form-group">
													...
													<div class="dropdown">
														<select class="form-control" name="cat_new">
														 <?php
														 	$result2=mysqli_query($conn,"SELECT *FROM categories WHERE finance_type_id=1");
